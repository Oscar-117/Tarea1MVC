...
using Tareas1MVC.Servicios;

namespace Tareas1MVC.Controllers
{
    public class UsuariosController: Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel modelo)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Usuario o contraseña es incorrecta.");
                return View(modelo);
            }
        }
        ...
        public async Task<IActionResult> RegistrarUsuarioExterno(string urlRetorno = null, string remoteError = null)
        {
            ...
            // Y si no tiene cuenta externa entonces
            string email = "";
